...
// Same .env-driven Maps key plumbing as the customer app. Missing key →
// blank tile, no crash.
...
android {
    namespace = "lk.dutchlanka.dutch_lanka_manager"
    ...
    compileOptions {
        ...
        // Required by flutter_local_notifications 17+ (uses java.time on
        // minSdk < 26). Pairs with the desugar_jdk_libs entry in dependencies.
    ...
    defaultConfig {
        ...
        applicationId = "lk.dutchlanka.dutch_lanka_manager"
